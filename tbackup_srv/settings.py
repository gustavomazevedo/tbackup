...
PROJECT_ROOT = PROJECT_PARENT + 'tbackup_srv/'
DATA_ROOT = PROJECT_PARENT + 'tbackup_srv/data/'
LOGIN_URL = '/tbackup_srv/accounts/login/'
#SITE_ROOT = '{}/tbackup_srv/'.format(HOMEPATH)
#SITE_ROOT = 'http://gruyere.lps.ufrj.br/~gustavo/tbackup/'
SITE_ROOT = '127.0.0.1:8080/'
...
DATABASES = {
    'default': {
        ...
        'NAME': DATA_ROOT + 'tbackup_srv.sqlite',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'y4cf6_*g7=^1wehe3p5ij2^q(yrd=^k8poj3@dl#-0*s1u=b^w'
