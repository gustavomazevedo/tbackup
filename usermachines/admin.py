...
from tbackup.usermachines.models import Maquina, Diretorio, Usuario, Credencial, Transferencia
from tbackup.usermachines.forms import MaquinaForm, DiretorioForm, UsuarioForm, CredencialForm, TransferenciaForm
